...
Compiler::Syntax_State_Return::Syntax_State_Return(LexAnalyzer * lex, SyntaxAnalysis * syn, Syntax_State * parent, std::string stateName)
	:Syntax_State(lex,syn,parent,stateName)
{
	
}

Compiler::Syntax_State_Return::~Syntax_State_Return()
{
}

void Compiler::Syntax_State_Return::checkSyntax()
{
